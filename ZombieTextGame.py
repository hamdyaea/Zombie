...
def begin():
    ...
    print(
        "After a virus created in the laboratory has been released by accident the world is now full of zombies."
    )
    ...
    if "west" in choice:
        ...
        print(
            """You carefully go through the narrow passage heading
...
def room_2():
    ...
    if "west" in choice:
        ...
        print(
            """You follow the bright path. As you walk, there are
more and more noise.
...
def room_3():
    ...
    if zombie_alive:
        ...
        print("What do you do?")
        print("Enter : east, gun, hole or south")
        ...
        if "east" in choice:
            ...
            print(
                """As you run towards the east passage, the zombie leaps
...
because the zombie opens its jaws and rips of your head."""
            ...
            print(
                """You take the flaming torch and wave it in front of the
...
hole, disappearing from the room."""
            ...
            print(
                """You take the gun. Suddenly, it starts emanating a faint
...
jump forward and kill the zombie."""
            ...
            print(
                """You jump in the dark. It wasn't
...
def room_4():
    ...
    if Big_zombie_alive:
        ...
        print(
            "In the room there's a big zombie. You can take your gun or walk to another directions."
        )
        ...
        if "gun":
            ...
            print(
                """Suddenly you take your gun out of your bag. An unknown force urges you and you shoot
...
you have to die.' He types something on the PC, and you die."""
            ...
            print(
                """The passage leads to the surface.
